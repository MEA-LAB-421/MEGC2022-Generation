...
from modules.inpainting_network_AU import InpaintingNetwork as InpaintingNetwork_AU
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", default="train", choices=["train", "reconstruction", "train_avd", "animate"])
    ...
    if config['dataset_params']['au_dir']:
        inpainting = InpaintingNetwork_AU(**config['model_params']['generator_params'],
    ...
    if opt.mode == 'train':
        ...
        print("Animate...")
        animate(config, inpainting, kp_detector, bg_predictor, dense_motion_network, opt.checkpoint, log_dir, dataset)
